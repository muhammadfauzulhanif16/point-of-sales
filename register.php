...
<!doctype html>
  <html lang="en">
    <head>
      ...
      <title>Register - Point of Sales</title>
    </head>
      ...
      <div class="flex flex-col items-center justify-center mx-auto space-y-6">
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="" method="post">
            ...
            <button type="submit" name="register" class="w-full bg-blue-400 hover:bg-blue-500 text-white font-medium rounded-full text-sm px-6 py-2 text-center">Sign in</button>
          </form>
        </div>
      </div>
